	...
	<div class="container custom-theme">
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="customer-name text-center mt-5"><h5>Hi {{$data['f_name']}} {{$data['l_name']}} </h5></div>
		...
		<div class="row mt-5 justify-content-center">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="personal-d">
					...
					<h6 class="mb-3"><b>Your Counsellor Name : </b>{{$data['counselor_name']}}</h6>
					<h6 class="mb-3"><b>Session Date : </b>{{$data['pre_date']}}</h6>
					<h6 class="mb-3"><b>Session Time : </b>{{$data['session_time']}}</h6>
					<h6 class="mb-3"><b>Your Email is: </b><a href="mailto:{{$data['email']}}">{{$data['email']}}</a></h6>
				</div>
			</div>
		</div>
		<div class="row mt-5">
